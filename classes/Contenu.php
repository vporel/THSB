...
class Contenu extends ElementSchema{
     ...
     */
    public function __construct(string $table, array $properties, string $imagesFolder, array $validationRules = []){
        $contenuProperties = [];
        ...
        parent::__construct($table, array_merge($contenuProperties, $properties), $validationRules);
    }
